...
export function WhyItMatters() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Pause before Card 02 begins to enter
      tl.to({}, { duration: 0.5 });
  ...
  return (
    <section ref={containerRef} className="relative h-[350vh] bg-[#070709] border-t border-border/10">
      <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden px-6 md:px-12 lg:px-24 pt-16">
        ...
        {/* Stack */}
        <div className="relative w-full max-w-[1100px] mx-auto h-[420px] md:h-[400px] z-10">
          ...
          >
            <div className="w-full md:w-[45%] p-8 md:p-10 flex flex-col justify-between bg-[#1A1A1C] relative z-10">
              <div>
                <div className="font-mono text-[10px] text-muted uppercase tracking-[0.15em] mb-6">
                  02 / FOR EDUCATORS
                </div>
